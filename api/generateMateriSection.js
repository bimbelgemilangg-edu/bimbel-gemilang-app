...
- INI JUGA TERMASUK "objek nyata": bagan/diagram referensi yang beneran ada wujudnya kayak contoh kartu peraga sekolah -- ini SERING KELEWAT, jadi diperjelas: kalau materi ngebahas TEKNIK/GAYA VISUAL yang MUSTAHIL dijelaskan tuntas cuma pakai teks (contoh: bentuk huruf tegak bersambung/sambung-menyambung tulisan tangan, pola motif batik, teknik lipatan origami, bentuk not balok musik, gerakan tarian/olahraga tertentu), itu WAJIB needs_image true dengan image_keyword yang tepat (contoh: "cursive handwriting practice sheet", "Indonesian batik pattern"). JANGAN PERNAH coba "gambarkan" teknik visual kayak gitu lewat teks doang (contoh GAGAL yang PERNAH KEJADIAN: menjelaskan huruf tegak bersambung cuma dengan "a - n - a - k ===> anak" -- itu SAMA SEKALI TIDAK menunjukkan bentuk sambungan hurufnya, cuma misahin huruf pakai tanda strip, GAK ADA GUNANYA buat siswa lihat wujud sambungannya). Kalau topiknya beneran butuh dilihat wujud visualnya dan bukan bisa dijelaskan tuntas lewat kata-kata, PRIORITASKAN needs_image daripada maksa jelasin lewat teks yang gak akan pernah cukup.
