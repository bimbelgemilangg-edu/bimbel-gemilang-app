...
const ALIAS_MAPEL = [
  ...
  { kode: 'sos', nama: ['sosiologi', 'sociology'] },
  { kode: 'ant', nama: ['antropologi'] },
  { kode: 'mtk_tl', nama: ['matematika tingkat lanjut', 'matematika lanjut', 'mtk tingkat lanjut'] },
  { kode: 'bind_tl', nama: ['bahasa indonesia tingkat lanjut', 'bahasa indonesia lanjut'] },
  { kode: 'bing_tl', nama: ['bahasa inggris tingkat lanjut', 'bahasa inggris lanjut', 'english advanced'] },
