...
// Sanitizer whitelist untuk bab bertipe HTML (v2).
// FIX v2: perbandingan tag CASE-INSENSITIVE. Sebelumnya elemen SVG
// (svg, line, polygon, text, ...) ikut terbuang karena tagName SVG
// huruf kecil, sehingga gambar hilang dan hanya label teks yang
// tersisa (terlihat "amburadul" di reader).
