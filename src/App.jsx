...
// --- IMPORT HALAMAN (Pastikan folder & nama filenya sesuai) ---
import AdminSchedule from './pages/admin/Schedule';
import AdminSettings from './pages/admin/Settings'; 
import AdminTeachers from './pages/admin/Teachers';
import TeacherDashboard from './pages/teacher/Dashboard';
import AdminFinance from './pages/admin/finance/index'; // <-- JALUR KEUANGAN
...
const DashboardHome = () => {
  ...
  useEffect(() => {
    ...
    const unsubStudents = onSnapshot(collection(db, "students"), s => {
      ...
      // Cek Renewal (contoh logika sederhana > 25 hari)
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden w-full relative bg-gray-50">
        ...
        <main className="flex-1 overflow-auto bg-gray-50 w-full relative">
          <div className="h-full w-full"> 
            ...
            {/* INI DIA BAGIAN KEUANGAN - PASTIKAN DB DIKIRIM */}
