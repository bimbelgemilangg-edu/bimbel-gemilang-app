...
// --- KOMPONEN PROTEKSI RUTE (DIPERBAIKI) ---

// Proteksi Admin: Mengecek isLoggedIn atau role admin
...
// Proteksi Guru: Mengecek isGuruLoggedIn atau role guru
...
// Proteksi Siswa: Mengecek isSiswaLoggedIn atau role siswa
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* === AREA GURU (Hanya bisa diakses role guru) === */}
        ...
        {/* === AREA SISWA (Hanya bisa diakses role siswa) === */}
        ...
        {/* === OTOMATIS REDIRECT JIKA SALAH ALAMAT === */}
        <Route path="/teacher/*" element={<Navigate to="/guru/dashboard" replace />} />
        {/* Jika user mengakses path yang tidak ada, balikkan ke login utama */}
