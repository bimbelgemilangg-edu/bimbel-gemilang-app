...
//
// Sebelumnya belum terhubung ke App.jsx.
// Sekarang kita hubungkan ke route:
// /admin/bank-soal
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Alias tambahan jika ada menu lama yang memakai
            /admin/banksoal */}
        <Route
          path="/admin/banksoal"
          element={
