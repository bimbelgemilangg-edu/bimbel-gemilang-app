...
// PERBAIKAN PATH: Sesuaikan dengan struktur folder pages/admin/settings/Settings.jsx
...
const Settings = () => {
  ...
  if (loading) return <div style={{padding: 50, textAlign:'center'}}>Memuat Konfigurasi...</div>;
      ...
      <div style={styles.mainContent}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            <h3 style={styles.headerGreen}>💰 Gaji Guru</h3>
          ...
          <div style={styles.card}>
            <h3 style={styles.headerBlue}>📚 Harga SPP</h3>
            <div style={styles.formGroup}><label>SD Paket 1</label><input type="number" value={prices.sd.paket1} onChange={(e) => setPrices({...prices, sd: {...prices.sd, paket1: parseInt(e.target.value)}})} style={styles.input} /></div>
...
const styles = {
  ...
  headerBlue: { color: '#2563eb', borderBottom: '1px solid #eee', paddingBottom: 10 },
  headerGreen: { color: '#059669', borderBottom: '1px solid #eee', paddingBottom: 10 },
  formGroup: { marginBottom: '15px', display:'flex', justifyContent:'space-between' },
  input: { width: '120px', padding: '8px', borderRadius: '8px', border: '1px solid #ddd', textAlign:'right' },
  btnSaveBig: { display:'flex', alignItems:'center', gap:8, padding: '10px 20px', background: '#1e293b', color: 'white', border: 'none', borderRadius: '10px', cursor: 'pointer' },
