    ...
    <div className="w-full h-screen flex flex-col bg-slate-50 overflow-hidden font-sans">
      ...
      <div className="bg-white px-8 py-4 border-b border-slate-200 flex justify-between items-center shadow-sm z-20 shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div><h1 className="text-xl font-black uppercase text-slate-800 tracking-tighter">KEUANGAN VERSI BARU</h1><p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Saldo Aktif: Rp {balance.toLocaleString('id-ID')}</p></div>
        </div>
