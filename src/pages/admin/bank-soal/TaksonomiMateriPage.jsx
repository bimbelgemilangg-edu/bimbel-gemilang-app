...
const SEED_MATEMATIKA = [
  ...
  { kelas: '3', jenjang: 'SD/MI', fase: 'B', elemen: ['Bilangan', 'Geometri', 'Pengukuran', 'Analisis Data dan Peluang'], babBaku: ['Bilangan cacah sampai 10.000', 'Penjumlahan dan pengurangan', 'Perkalian dan pembagian', 'Pecahan sederhana', 'Pengukuran (panjang, berat, waktu)', 'Keliling bangun datar', 'Sudut dan bangun datar', 'Penyajian data sederhana'] },
  { kelas: '4', jenjang: 'SD/MI', fase: 'B', elemen: ['Bilangan', 'Aljabar', 'Geometri', 'Pengukuran', 'Analisis Data dan Peluang'], babBaku: ['Bilangan cacah sampai 100.000', 'Faktor dan kelipatan', 'Pecahan dan desimal', 'Keliling dan luas', 'Bangun datar dan ruang', 'Pengumpulan dan penyajian data'] },
  { kelas: '5', jenjang: 'SD/MI', fase: 'C', elemen: ['Bilangan', 'Geometri', 'Pengukuran', 'Analisis Data dan Peluang'], babBaku: ['Bilangan bulat', 'Operasi hitung pecahan', 'Desimal dan persen', 'Luas dan volume', 'Bangun ruang', 'Kecepatan dan debit', 'Pengumpulan dan penyajian data'] },
  { kelas: '6', jenjang: 'SD/MI', fase: 'C', elemen: ['Bilangan', 'Aljabar', 'Geometri', 'Analisis Data dan Peluang'], babBaku: ['Operasi hitung campuran bilangan bulat', 'Pecahan dan perbandingan', 'Volume bangun ruang', 'Statistika dasar', 'Koordinat kartesius', 'Skala dan perbandingan'] },
  { kelas: '7', jenjang: 'SMP/MTs', fase: 'D', elemen: ['Bilangan', 'Aljabar', 'Geometri', 'Analisis Data dan Peluang'], babBaku: ['Bilangan bulat dan pecahan', 'Himpunan', 'Bentuk aljabar', 'Persamaan dan pertidaksamaan linear satu variabel', 'Perbandingan', 'Garis dan sudut', 'Segiempat dan segitiga', 'Penyajian data'] },
  { kelas: '8', jenjang: 'SMP/MTs', fase: 'D', elemen: ['Bilangan', 'Aljabar', 'Geometri', 'Analisis Data dan Peluang'], babBaku: ['Pola bilangan', 'Koordinat kartesius', 'Relasi dan fungsi', 'Persamaan garis lurus', 'Sistem persamaan linear dua variabel', 'Teorema Pythagoras', 'Lingkaran', 'Bangun ruang sisi datar', 'Statistika', 'Peluang'] },
  { kelas: '9', jenjang: 'SMP/MTs', fase: 'D', elemen: ['Bilangan', 'Aljabar', 'Geometri', 'Analisis Data dan Peluang'], babBaku: ['Perpangkatan dan bentuk akar', 'Persamaan kuadrat', 'Fungsi kuadrat', 'Transformasi geometri', 'Kesebangunan dan kekongruenan', 'Bangun ruang sisi lengkung', 'Statistika', 'Peluang'] },
  ...
  { kelas: '11', jenjang: 'SMA/MA', fase: 'F', elemen: ['Aljabar dan Fungsi', 'Geometri', 'Analisis Data dan Peluang'], babBaku: ['Trigonometri lanjutan', 'Program linear', 'Matriks', 'Fungsi komposisi dan invers', 'Lingkaran (persamaan)', 'Statistika', 'Peluang'] },
