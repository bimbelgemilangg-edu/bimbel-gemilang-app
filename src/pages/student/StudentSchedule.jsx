...
const StudentSchedule = () => {
  ...
  // SENDIRI + mengatur marginLeft-nya sendiri (270px, angka lama sebelum
  // sidebar dirapikan jadi 260px). Padahal di App.jsx, route "/siswa/jadwal"
  // SUDAH dibungkus <SiswaLayout> yang JUGA render sidebar + offset-nya
  // sendiri. Akibatnya sidebar dobel (numpuk, boros) dan konten ke-geser
  // dua kali (260 dari SiswaLayout + 270 dari sini = ~530px kosong di
  // desktop). Sekarang komponen ini HANYA render kontennya sendiri, persis
  // seperti StudentElearning.jsx dkk yang sudah benar dari awal.
  return (
