...
// Import modules dengan cara yang benar
...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchAll = async () => {
      setLoading(true);
      console.log('🚀 Fetch data untuk studentId:', studentId);
      ...
      try {
        ...
        try {
          ...
          console.log('🖼️ Posters:', postersSnap.size);
        } catch (e) {
        ...
        try {
          ...
          console.log('📅 Jadwal:', scheds.length);
        } catch (e) {
