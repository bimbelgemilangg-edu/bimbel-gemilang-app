...
import { 
  ...
  ChevronRight, Filter, AlertCircle, Calendar,
...
const ModulManager = () => {
  ...
  const fetchModuls = async () => {
    setLoading(true);
    try {
      // Mengurutkan berdasarkan update terbaru agar guru mudah menemukan kerjaan terakhir
      ...
      // Fallback jika index orderBy belum dibuat di Firebase Console
  ...
  // Logic Filtering yang diperluas
  ...
  // Ambil list mata pelajaran unik untuk dropdown filter
...
// --- STYLING (SENIOR ARCHITECT LEVEL) ---
const st = {
...
// Injection CSS untuk animasi spinner
