...
import { 
  ...
  Download, Trash2, FileText, HelpCircle, User, BookOpen, BarChart3
} from 'lucide-react';
...
const CekTugasSiswa = () => {
  ...
  return (
    <div className="main-content-wrapper">
      <div className="teacher-container-padding" style={{marginLeft: window.innerWidth > 768 ? '260px' : '0'}}>
        ...
        {loading ? (
            ...
            <div className="teacher-card" style={{padding: 0, overflowX: 'auto', borderRadius: '20px'}}>
                <table style={styles.table}>
                    ...
                    <tbody>
                        {filtered.length > 0 ? filtered.map((item) => {
                            // Handler Tanggal Firestore (Timestamp vs String)
                            let timeString = "-";
                            if (item.submittedAt) {
                                    ...
                                    <td style={styles.td}>
                                        <div style={styles.scoreContainer}>
                                            {editingScore === item.id ? (
                                                ...
                                                <span style={{
                                                    ...styles.scoreDisplay, 
                                                    color: item.score >= 75 ? '#10b981' : '#f43f5e'
                                                }}>
                                                    {item.score ?? '--'}
                                                </span>
                                            )}
...
// Styles tetap menggunakan yang Anda buat dengan sedikit perbaikan pada spacing
const styles = {
  // ... (Gunakan styles yang sudah Anda miliki di prompt sebelumnya)
  // Tambahkan sedikit penyesuaian margin agar konsisten dengan ManageQuiz
  ...
  searchBox: { display: 'flex', alignItems: 'center', gap: '10px', background: 'white', padding: '10px 18px', borderRadius: '12px', width: '300px', border: '1px solid #e2e8f0' },
